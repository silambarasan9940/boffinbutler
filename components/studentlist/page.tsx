...
const StudentListing = () => {
  ...
  const handleButtonClick = (type: "edit" | "reject" | "approve", order: OrderData) => {
    setModalTitle(type === "edit" ? "Edit Student" : type === "reject" ? "Reject Student" : "Approve Student");
  ...
  return (
    <div className="p-6">
      ...
      {isModalOpen && selectedStudent && modalTitle === 'Edit Student' && (
        <Modal title={modalTitle} onClose={closeModal}>
          <CreateStudentForm 
            studentData={selectedStudent} 
            showtitle={false} 
            onClose={handleUpdateStudent} 
          />
        </Modal>
      )}
      {isModalOpen && selectedStudent && modalTitle === 'Reject Student' && (
        <Modal title={modalTitle} onClose={closeModal}>
          <div className="text-center">
            <div className="py-6">Are you sure you want to Reject?</div>
            <button onClick={() => handleStatus(selectedStudent.id, 'notapproved')}
      ...
      {isModalOpen && selectedStudent && modalTitle === 'Approve Student' && (
        <Modal title={modalTitle} onClose={closeModal}>
          <div className="text-center">
            <div className="py-6">Are you sure you want to Approve?</div>
            <button onClick={() => handleStatus(selectedStudent.id, 'approved')}
