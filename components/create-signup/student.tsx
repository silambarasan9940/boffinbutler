...
const Student = ({
  ...
  const validateForm = () => {
    ...
    if (!formData.street)
      errors.registerAddress = "You have to add Register address";
    ...
    if (formData.faculty === "others" && !formData.other_faculty_email)
      errors.other_faculty_email = "Please add Faculty email";
    if (formData.faculty === "others" && !formData.other_faculty_firstname)
      errors.other_faculty_firstname = "Please add Faculty email";
    if (formData.faculty === "others" && !formData.other_faculty_lastname)
      errors.other_faculty_lastname = "Please add Faculty email";
    if (formData.faculty === "others" && !formData.other_faculty_mobile)
      errors.other_faculty_mobile = "Please add Faculty email";
        ...
        requestPayload.customer.customAttributes.push({
          ...
          value: {
            ...
            name:
              ...
              "." +
              formData.studentidcard.fileName.split(".")[1],
          },
        });
      }
  ...
  const fetchFaculty = async (
    ...
    try {
      const response = await api.get(`/faculties/${value}`);
      console.log(formData.institute, "insitiute");
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => {
                    handleInputChange(e), fetchFaculty(e);
                  }}
                >
              ...
              {formData.faculty === "others" && (
                <>
                  <div>
                    <label
                      htmlFor="other_faculty_firstname"
                      className="block text-sm font-medium"
                    >
                  ...
                  <div>
                    <label
                      htmlFor="other_faculty_lastname"
                      className="block text-sm font-medium"
                    >
